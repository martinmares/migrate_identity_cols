...
func main() {
	...
	fmt.Println("Data sourceName:", aurora.Green(*dataSourceNameArg))
	fmt.Println("User name:", aurora.Green(*userNameArg))
	fmt.Println("Password:", aurora.Green(*passwordArg))
	...
	if len(sequencesFinal) > 0 {
		...
		for _, seq := range sequencesFinal {
			...
			fmt.Println(aurora.Magenta(alter))
		}
	}
